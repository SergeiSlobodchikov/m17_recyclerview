...
class PhotoAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoHolder {
        val binding = FragmentPhotoBinding.inflate(LayoutInflater.from(parent.context))
...
class PhotoHolder(val binding: FragmentPhotoBinding) : RecyclerView.ViewHolder(binding.root)
